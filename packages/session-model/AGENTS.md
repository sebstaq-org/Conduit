...
- Provider snapshots, raw wire events, and prompt lifecycle snapshots are diagnostic/provider truth until a stable frontend read-model exposes them through `src/app-state`.
