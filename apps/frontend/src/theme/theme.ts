...
const lightTheme = createTheme({
  ...
  colors: {
    ...
    connectionConnected: "#218a4a",
    connectionConnecting: "#5b5b5b",
    connectionDisconnected: "#c73737",
    connectionIdle: "#b7b7b7",
...
const darkTheme = createTheme({
  ...
  colors: {
    ...
    connectionConnected: "#37c878",
    connectionConnecting: "#d6d8db",
    connectionDisconnected: "#ff6b6b",
    connectionIdle: "#9a9fa5",
    errorToastBackground: "#fde8e8",
    errorToastBorder: "#f4c7ca",
    errorToastClose: "#7c8a84",
    errorToastIconBackground: "#ef6b72",
