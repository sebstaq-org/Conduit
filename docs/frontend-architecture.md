...
This document is the canonical frontend architecture note for the current workspace shape.
...
- `apps/desktop`
  - Electron shell, desktop integration, and the minimal Phase 1 proof surface
- `apps/mobile`
